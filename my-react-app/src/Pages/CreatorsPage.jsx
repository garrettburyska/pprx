...
const CREATORS = [
    { name: 'Riodjaja 🇮🇩', imageUrl: '/image7.jpg', 
        socials: [
    ...
    { name: 'Spicyuuu 🇸🇬', imageUrl: '/image8.jpg', 
        socials: [
    ...
    { name: 'BrimCanhCut 🇻🇳', imageUrl: '/image10.jpg', 
        socials: [
    ...
    { name: 'Lavandula 🇮🇩', imageUrl: '/image11.webp', 
        socials: [
